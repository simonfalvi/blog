        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('blogApp.entry.title')} id="entry-title" name="title" data-cy="title" type="text" />
              <ValidatedField
                label={translate('blogApp.entry.content')}
                id="entry-content"
                name="content"
                data-cy="content"
                type="textarea"
              ...
              />
              <ValidatedField
                label={translate('blogApp.entry.date')}
                id="entry-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField id="entry-blog" name="blogId" data-cy="blog" label={translate('blogApp.entry.blog')} type="select">
                <option value="" key="0" />
                {blogs
              ...
              <ValidatedField label={translate('blogApp.entry.tag')} id="entry-tag" data-cy="tag" type="select" multiple name="tags">
                <option value="" key="0" />
                {tags
